...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='gov.conf'
CONFIGFOLDER='/root/.GOV'
COIN_DAEMON='govd'
COIN_CLI='gov-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/testcryptoyeah/testcryptoyeah/releases/download/v1/gov.zip'
...
function important_information() {
 ...
 echo -e "${GREEN}gov-cli masternode status${NC}"
 echo -e "${GREEN}gov-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
